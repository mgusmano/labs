Ext.define('AppCamp.model.AgencyPortfolioModel', {
	...
	fields: [
		...
		{ name: 'investmentCategory', type: 'string' }, //"00",  (all data by investment category)
		{ name: 'lobTitle', type: 'string' }, //"N\/A",
		{ name: 'bureauCode', type: 'string' }, //"03",
		{ name: 'bureauName', type: 'string' }, //"Office of the Secretary", (agency spending by bureau)
		...
		{ name: 'feaBRMservicesPrimaryServiceArea', type: 'string' }, //"139 - Provide and Maintain IT Infrastructure",  (agency by primary services area)
